...
refused_long_visas <- read_csv("refused_long_year_nationality.csv", show_col_types = FALSE)
refused_short_visas <- read_csv("refused_short_year_nationality.csv", show_col_types = FALSE)
granted_long_visas <- read_csv("granted_long_year_nationality.csv", show_col_types = FALSE)
granted_short_visas <- read_csv("granted_short_year_nationality.csv", show_col_types = FALSE)
...
write_csv(combined_visas, "combined_visas.csv")
```
